  ...
  return (
    <div className="lg:w-[80%] mx-auto">
      <div className="flex  justify-between  mt-4 mb-6">
        <div>
          <span className="px-2">Latest Tablet</span>
        </div>
        <div>
          <a
      ...
      <div className="w-full">
        <Slider {...settings}>
          <div className="card-text">
            <img src="images/tablet-1.webp" alt="slider image" />
          ...
          <div className="card-text">
            <img src="images/tablet-2.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-3.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-4.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-5.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-6.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-7.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-8.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-9.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/tablet-10.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
