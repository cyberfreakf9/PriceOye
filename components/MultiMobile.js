  ...
  return (
    <div className="lg:w-[80%] mx-auto">
      <div className="flex  justify-between  mt-4 mb-6">
        <div>
          <span className="px-2">Latest Mobiles</span>
        </div>
        <div>
          <a
      ...
      <div className="w-full">
        <Slider {...settings}>
          <div className="card-text">
            <img src="images/mobile-1.webp" alt="slider image" />
          ...
          <div className="card-text">
            <img src="images/mobile-2.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-3.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-4.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-5.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-6.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-7.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-8.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-9.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
          ...
          <div className="card-text">
            <img src="images/mobile-10.webp" alt="slider image" />
            <h6>itel Wireless Earbuds (KT-01)</h6>
            <div className="px-3">
              <span>R.2499</span>
            </div>
